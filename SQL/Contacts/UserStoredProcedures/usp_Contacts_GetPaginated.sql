CREATE OR ALTER PROCEDURE [dbo].[usp_Contacts_GetPaginated]
...
BEGIN
	...
	-- calculate tthe starting and ending of records
	...
	SELECT RowNumber, TotalCount, @StartRow, @EndRow, [Id], [FirstName], [LastName], [TelephoneNumber_Entry], [Email], [ModifiedUTC], [ModifiedBy], [CreatedUTC], [CreatedBy], [IsDeleted]
	FROM CTEResult
